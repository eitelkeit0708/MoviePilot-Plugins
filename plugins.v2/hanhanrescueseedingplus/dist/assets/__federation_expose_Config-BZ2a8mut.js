                    ...
                    _createVNode(_component_v_col, { cols: "12" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_select, {
                          ...
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.downloader) = $event)),
                      ...
                      ? (_openBlock(), _createBlock(_component_v_col, {
                          ...
                          default: _withCtx(() => [
                            _createVNode(_component_v_text_field, {
                              ...
                              "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.user_id) = $event)),
                              label: "用户ID",
                              type: "number",
                              placeholder: "请输入用户ID",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.seeding_count) = $event)),
                          label: "做种人数",
                          type: "text",
                          placeholder: "请输入做种人数",
                          hint: "例:3或者1-3",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((config.download_limit) = $event)),
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((config.save_path) = $event)),
                          label: "保存路径",
                          placeholder: "请输入保存路径",
                          hint: "设置种子文件的保存路径",
                          "persistent-hint": ""
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((config.custom_tag) = $event)),
                          label: "自定义标签",
